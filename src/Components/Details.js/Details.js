...
const Details = ({ viewDetail, setViewDetail }) => {
  return (
    <>
      {viewDetail ? (
        <SinglePage />
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="w-[94%] mt-2 md:mt-0 xl:w-[996px] flex flex-col gap-[2px] rounded bg-white">
            <div className="flex w-auto items-center flex-col md:flex-row h-auto md:h-[192px] mt-[2px] gap-4">
              <div className="w-[310px] h-[200px] md:w-[280px] md:h-40 rounded mt-4 ">
                <img
